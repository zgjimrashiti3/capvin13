...
export default function MenuPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#f8f8f8', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      {/* Table number modal — shown until table is set, or when editing */}
      {(!tableNumber || editTable) && <TableModal onDone={() => setEditTable(false)} />}
          ...
          <div className="flex items-center gap-3">
            {tableNumber && (
              <button
                ...
                className="flex items-center gap-1.5 text-white/80 hover:text-white text-xs lg:text-sm font-medium transition-colors"
              >
